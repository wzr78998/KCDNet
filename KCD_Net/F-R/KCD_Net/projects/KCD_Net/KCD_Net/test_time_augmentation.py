...
class KCDNetWithTTA(GeneralizedRCNNWithTTA):
    """
        A KCDNet with test-time augmentation enabled.
        Its :meth:`__call__` method has the same interface as :meth:`KCDNet.forward`.
    """
    ...
    def __init__(self, cfg, model, tta_mapper=None, batch_size=3):
        """
            Args:
                cfg (CfgNode):
                model (KCDNet): a KCDNet to apply TTA on.
        ...
        self.max_detection = cfg.MODEL.KCDNet.NUM_PROPOSALS
    ...
    def _batch_inference(self, batched_inputs, detected_instances=None):
        ...
        Inputs & outputs have the same format as :meth:`KCDNet.forward`
        """
    ...
    def _merge_detections(self, all_boxes, all_scores, all_classes, shape_hw):
        ...
        num_classes = self.cfg.MODEL.KCDNet.NUM_CLASSES
